...
public class WizardContribution implements Comparable<WizardContribution> {
	...
	public static Map<String, WizardContribution> getFromRegistry() {
		...
		for (int i = 0; i < config.length; i++) {
			...
			elements.put(name, new WizardContribution(name, mweSnippet,
					requiredBundles, sortKey));
		}
		return elements;
	}
	...
	public WizardContribution(String name, String mweSnippet,
			String[] requiredBundles, String sortKey) {
		super();
		this.name = name;
