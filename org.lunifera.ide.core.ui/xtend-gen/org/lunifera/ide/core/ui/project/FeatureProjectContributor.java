...
public class FeatureProjectContributor extends DefaultProjectFactoryContributor {
  ...
  private void createFeatureXML(final IProjectFactoryContributor.IFileCreator fileWriter) {
    ...
    _builder.append("      ");
    _builder.append("version=\"");
    String _bundleProjectVersion = this.projectInfo.getBundleProjectVersion();
    _builder.append(_bundleProjectVersion, "      ");
    _builder.append("\"");
    _builder.newLineIfNotEmpty();
    _builder.append("      ");
    _builder.append("provider-name=\"Lunifera GmbH\">");
    _builder.newLine();
    _builder.newLine();
    _builder.append("   ");
    _builder.append("<description>");
    ...
    _builder.newLine();
    _builder.append("         ");
    _builder.append("id=\"org.lunifera.samples.carstore.dtos\"");
    _builder.newLine();
    _builder.append("         ");
    ...
    _builder.newLine();
    _builder.append("         ");
    _builder.append("id=\"org.lunifera.samples.carstore.entities\"");
    _builder.newLine();
    _builder.append("         ");
    _builder.append("download-size=\"0\"");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("         ");
    _builder.append("id=\"org.lunifera.samples.carstore.ui.application\"");
    _builder.newLine();
    _builder.append("         ");
    _builder.append("download-size=\"0\"");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("         ");
    _builder.append("id=\"org.lunifera.samples.carstore.bootstrap\"");
    _builder.newLine();
    _builder.append("         ");
    _builder.append("download-size=\"0\"");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("         ");
    _builder.append("id=\"org.lunifera.samples.carstore.ui.mobile\"");
    _builder.newLine();
    _builder.append("         ");
    _builder.append("download-size=\"0\"");
    _builder.newLine();
